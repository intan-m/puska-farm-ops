-- View
CREATE OR REPLACE VIEW history_populasi_cdc AS
WITH cte_raw_parse AS (
  SELECT
    ...
    (old_data->>'jml_pedaging_jantan')::INT4 AS old_jml_pedaging_jantan,
    (old_data->>'jml_pedaging_betina')::INT4 AS old_jml_pedaging_betina,
    (old_data->>'jml_pedaging_anakan_jantan')::INT4 AS old_jml_pedaging_anakan_jantan,
    (old_data->>'jml_pedaging_anakan_betina')::INT4 AS old_jml_pedaging_anakan_betina,
    (old_data->>'jml_perah_jantan')::INT4 AS old_jml_perah_jantan,
    (old_data->>'jml_perah_betina')::INT4 AS old_jml_perah_betina,
    (old_data->>'jml_perah_anakan_jantan')::INT4 AS old_jml_perah_anakan_jantan,
    (old_data->>'jml_perah_anakan_betina')::INT4 AS old_jml_perah_anakan_betina,
    (new_data->>'id')::INT8 AS new_id,
    (new_data->>'tgl_pencatatan')::DATE AS new_tgl_pencatatan,
    (new_data->>'id_peternak')::INT8 AS new_id_peternak,
    (new_data->>'jml_pedaging_jantan')::INT4 AS new_jml_pedaging_jantan,
    (new_data->>'jml_pedaging_betina')::INT4 AS new_jml_pedaging_betina,
    (new_data->>'jml_pedaging_anakan_jantan')::INT4 AS new_jml_pedaging_anakan_jantan,
    (new_data->>'jml_pedaging_anakan_betina')::INT4 AS new_jml_pedaging_anakan_betina,
    (new_data->>'jml_perah_jantan')::INT4 AS new_jml_perah_jantan,
    (new_data->>'jml_perah_betina')::INT4 AS new_jml_perah_betina,
    (new_data->>'jml_perah_anakan_jantan')::INT4 AS new_jml_perah_anakan_jantan,
    (new_data->>'jml_perah_anakan_betina')::INT4 AS new_jml_perah_anakan_betina
  FROM log_cdc_prc
  WHERE table_name = 'history_populasi'
